...
class CreatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create creator" do
    assert_difference('Creator.count') do
      post creators_url, params: { creator: { about: @creator.about, approved: @creator.approved, user_id: @creator.user_id } }
    end
  ...
  test "should update creator" do
    patch creator_url(@creator), params: { creator: { about: @creator.about, approved: @creator.approved, user_id: @creator.user_id } }
