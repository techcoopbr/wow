...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post developers_url, params: { developer: { about: @developer.about, description: @developer.description, name: @developer.name, photo: @developer.photo } }
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { about: @developer.about, description: @developer.description, name: @developer.name, photo: @developer.photo } }
